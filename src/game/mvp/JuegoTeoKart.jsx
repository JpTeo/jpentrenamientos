...
//
// Este componente no sabe nada de rutas ni de la app que lo contiene: recibe
// por `salida` lo que se muestra abajo del menú (un enlace, un botón, nada).
// Así el mismo juego sirve dentro de la app y empaquetado suelto.
import { useCallback, useEffect, useRef, useState } from 'react'
import { MARCA } from '../marca.js'
import { SOCIOS } from '../characters/socios.js'
import { Carrera, FASE } from './carrera.js'
import { META_PISTA } from './pista.js'
import './juego.css'
...
export default function JuegoTeoKart({ salida = null }) {
...
function Menu({ personaje, elegir, jugar, salida }) {
  return (
    <div className="tk">
